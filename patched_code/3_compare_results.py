...
def main():
    # Load results
    pca_df = pd.read_csv('../patched_code_results/pca_results.csv')
    ae_df = pd.read_csv('../patched_code_results/autoencoder_results.csv')
    tf_df = pd.read_csv('../patched_code_results/transformer_results.csv')
    ...
    plt.tight_layout()
    plt.savefig('../patched_code_results/comparison_all_methods.png', dpi=300)
    print("\n✅ Comparison plots saved to '../patched_code_results/comparison_all_methods.png'")
